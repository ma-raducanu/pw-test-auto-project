...
1. Download and install Node.js from https://nodejs.org/en/download (make sure to check "Automatically install the necessary tools" and install the rest as well);
